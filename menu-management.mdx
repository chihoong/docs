...
description: "Day-to-day menu jobs: 86'ing items, menu groups, collections, and Square sync"
icon: "utensils"
---
...
<Frame>
  ![Kiosk menu showing menu group titles down the left side and a menu group cover image at the top of the Drinks & Smoothies section](/images/menugroups.png)
</Frame>
...
- [Loyalty](/loyalty) — promote rewards signup with a Collection.
- [Kiosk operations](/kiosk-operations) — set which profile (and menu) a device runs.
